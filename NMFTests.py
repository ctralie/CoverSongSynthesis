...
def testNMF1DTranslate():
    ...
    (W, H) = doNMF1DConv(np.abs(S), K, T=T, L=80, plotfn=plotfn)
    sio.savemat("SmoothCriminalNMF.mat", {"W":W, "H":H, "S1":S1, "S2":S2})
    ...
    (Ss1, Ratios1) = getComplexNMF1DTemplates(S1, W1, H, p = 2, audioParams=audioParams)
